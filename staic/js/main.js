...
loadAllTimeChart = async (country) => {
  ...
  if (isGlobal(country)) {
    ...
    // console.log("recovered_data", recovered_data);
    // console.log("deaths_data", deaths_data);
  } else {
...
initTheme = () => {
  let dark_mode_switch = document.querySelector("#darkmore-switch");
